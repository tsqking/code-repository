...
<body style="padding: 10px">
	...
	<form name="form1" method="post" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit"
			align="center">
			<tr>
				<td align="right" class="l-table-edit-td"><span class="l-star">*</span>&nbsp;菜单编号:</td>
				<td align="left" class="l-table-edit-td" style="width: 160px">
					<input name="mnu_id" type="text" id="mnu_id" ltype="text"
	...
	<script src="../lib/jquery-validation/messages_cn.js"
		type="text/javascript"></script>
	<script type="text/javascript" src="../lib/tm/menuinfo/addMenuInfo.js"></script>

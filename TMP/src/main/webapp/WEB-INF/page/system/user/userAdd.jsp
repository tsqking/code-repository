...
<!-- 页面js -->
<script src="${pageContext.request.contextPath}/system/user/userAdd.js"></script>
<!-- js国际化 -->
<script
						...
						<div class="tab-content">
							<div class="active tab-pane" id="pointInfo1">
								<div class="row">
										...
										<div class="form-group">
											...
											<div class="input-group">
												<span class="input-group-addon"><li
													...
													type="hidden" id="hiddenPwd" name="password" />
											</div>
										</div>
										<div class="form-group">
									...
									<div class="col-md-3 col-xs-3">
										<div class="form-group">
											<label for="cardtype"> <!-- 证件类型 --> <s:property
										...
										<div class="form-group">
											<label for="cardno"> <!-- 证件号码 --> <s:property
													value="getText('cardno')" /><small><i class="fa fa-star notNull"></i></small>
											</label>
											<div class="input-group">
												<span class="input-group-addon"><li

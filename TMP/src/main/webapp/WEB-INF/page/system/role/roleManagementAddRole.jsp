						...
						<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon"><li
									...
									name="role.name_en_US" id="roleName_en_US"
					...
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon"><li
									class="fa fa-bullhorn"></li></span> <input type="text"
									name="role.description" id="roleDesc"
					...
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon"><li
									class="fa fa-bullhorn"></li></span> <input type="text"
									name="role.description_en_US" id="roleDesc_en_US"
...
$(function() {
	parent.layer.iframeAuto(index);
	//下拉框初始化
	selectInitial("roleEnable","../system/option!getOptionsByGPVal.do?value=STATUS","T",false);
	adjust();
});

...
<body>
	...
	<!-- highcharts容器 -->
	<div id="ageCharts" style="width: 100%; height: 470px;"></div>
</body>
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/analysisReport/ageDistribution/ageAnalysis.js"></script>
<script
	src="${pageContext.request.contextPath}/analysisReport/ageDistribution/${system_lang}.js"></script>
</html>
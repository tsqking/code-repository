	...
	<div id="box">
		...
		<div class="row">
			<div class="col-md-1 col-xs-1" style="text-align:right;padding-right:0px;padding-top:8px;">
				 <input type="checkbox" name="checkbox1" id="options1" value="true">
	   		</div>
	   ...
	   <!-- <div class="row">
			<div class="col-md-1 col-xs-1" style="text-align:right;padding-right:0px;padding-top:8px;">
				 <input type="checkbox" name="checkbox2" id="options2" value="true">
	   		</div>
			<div class="col-md-3 col-xs-3">
				<div class="form-group">
				     <input type="text" class="form-control" placeholder="正确一">
	   ...
	   <div class="row">
			<div class="col-md-1 col-xs-1" style="text-align:right;padding-right:0px;padding-top:8px;">
				 <input type="checkbox" name="checkbox3" id="options3" value="true">
	   		</div>
			<div class="col-md-3 col-xs-3">
				<div class="form-group">
				     <input type="text" class="form-control" placeholder="正确一">
	   ...
	   <div class="row">
			<div class="col-md-1 col-xs-1" style="text-align:right;padding-right:0px;padding-top:8px;">
				 <input type="checkbox" name="checkbox4" id="options4" value="true">
	   		</div>
			<div class="col-md-3 col-xs-3">
				<div class="form-group">
				     <input type="text" class="form-control" placeholder="正确一">
...
$(function(){
	...
	for(var i=0; i<selectItems.length; i++){
		$("#addButton").before('<div class="row">'+
				...
				'<div class="col-md-3 col-xs-3">'+
					'<div class="form-group">'+
 						'<input type="text" class="form-control" value=\"'+selectItems[i]+'\" placeholder="答案">'+
					'</div>'+
				'</div>'+
				'<div class="col-md-1 col-xs-1" style="text-align:left;padding-right:0px;padding-top:8px;">'+
						'<a href=\"javascript:void(0);\" class=\"trash\"><i class=\"glyphicon glyphicon-trash\"></i></a>'+
	...
	$("#addItems").click(function(){
		...
		if(rows.length<8){
			...
			parent.layer.msg(optionLimitTip);//var optionLimitTip="选项个数请不要大于六个"
		}
	});

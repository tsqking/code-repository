		...
		<div class="row">
			<div class="col-md-9 col-xs-9">
				<div class="form-group">
					...
					<textarea class="form-control" rows="3" name="content" id="content" style="width: 100%;" readonly></textarea>
				</div>
			</div>
		</div>
...
$(function(){
	...
	document.getElementById('questionNumber').disabled=true;
		...
		$("#selectItems").append('<div class="row" style="margin-left:10%; margin-bottom:10px;">'+
									'<div class="col-md-3 col-xs-3">'+
										'<div class="input-group">'+
								            ...
								            '<input type="text" class="form-control" value=\"'+selectItems[i]+'\" readonly>'+
								      	'</div>'+
									'</div>'+
								'</div>');
	}

...
<script
	src="${pageContext.request.contextPath}/question/question/findImage.js"></script>
<!-- js国际化 -->
<script
...
<body>
	...
	<input style="display: none" id="imgType" value="${questionVo.imgType}" />
	<input style="display: none" id="edit" value="${questionVo.edit}" />
	<div class="box-body" align="center">
		<div class="row" id="text">
			<div class="col-md-12 col-xs-12">
				<label><s:text name="findImage_44_delete_image"/></label><!-- findImage_44_delete_image:点击图片即可删除 -->
			</div>
		</div>
		...
		<div class="col-md-12 col-xs-12"
			...
			<div class="col-md-3 col-xs-3">
				<button type="button" id="closeButton" style="margin-bottom: 10px;"
					...
					<i class="fa fa-close"></i>&nbsp;&nbsp;&nbsp;<s:text name="findImage_44_close_page"/></button><!-- findImage_44_close_page:关闭页面 -->
			</div>
		</div>
	</div>
</body>

	...
	<div id="box">
		...
		<div class="row">
			<div class="col-md-1 col-xs-1" style="text-align:right;padding-right:0px;padding-top:8px;">
				 <input type="radio" name="optionsRadiosinline" id="optionsRadios1" value="true" disabled>
	   		</div>
	   ...
	   <div class="row">
			<div class="col-md-1 col-xs-1" style="text-align:right;padding-right:0px;padding-top:8px;">
				 <input type="radio" name="optionsRadiosinline" id="optionsRadios2" value="true" disabled>
	   		</div>
			<div class="col-md-3 col-xs-3">
				<div class="form-group">
				     <input type="text" class="form-control" readonly>
...
$(function(){
	...
	for(var i=0; i<selectItems.length; i++){
		$("input[type='text']").eq(i).val(returnCharactor(returnCharactor(selectItems[i])));
	}
	//页面重新布局

...
<!-- js页面 -->
<script
	src="${pageContext.request.contextPath}/question/paper/addPaper.js"></script>
<!-- js国际化 -->
		...
		<div class="box">
			<div class="box-body" id="box">
				<form id="addForm" class="form-horizontal">
					<!-- 试卷Id -->
					<input type="hidden" name="id" id="paperVo_id" />
					...
					<div class="box-footer" style="padding: 2% 4% 0 0;">
						<div class="row">
							<div class="col-md-12 col-xs-12" style="margin-top:10px;">
								...
								<div class="col-md-3 col-xs-3">
									<button type="button" id="nextButton"
											class="btn btn-block btn-primary btn-sm"><i class="fa fa-arrow-right"></i>&nbsp;&nbsp;&nbsp;<s:text name="nextButtonAndCreate"/></button>
								</div>
							</div>
						</div>
					</div>

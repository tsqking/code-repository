...
<!-- 页面js -->
 <script src="${pageContext.request.contextPath}/campusRecruit/univ/college/collegeManage.js"></script> 
<!-- js国际化 -->
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<label><s:text name="college.name" /></label> <select
								class="form-control select" class="collegeName"
								name="id" id="collegeName" style="width: 100%;">
								<option value=""></option>
							</select>
						</div>
					</div>
		...
		<div class="col-xs-12">
			<div class="box box-primary" style="margin-bottom: 5px;">
				<div class="box-header">
					<h3 class="box-title"><s:text name="college.collegeListTitle"/></h3>
				</div>
				<div class="box-body">

...
<!-- 页面js -->
<script
	src="${pageContext.request.contextPath}/campusRecruit/univ/university/editUniversity.js"></script>
<script
		...
		<form id="editForm">
			...
			<div class="box-body">
				<div class="row">
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							<label for="name"><s:text name="university.name" /><small><i class="fa fa-star notNull"></i></small></label> 
							<div class="input-group">
								<span class="input-group-addon"><li class="fa  fa-university"></li></span> 
								<input type="text"
									name="universityVo.name" id="name" value="${universityVo.name }"
									class="form-control" onblur="checkRepetition();">
							</div>
						</div>
					</div>
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							<label for="type"><s:text name="university.type" /><small><i
									class="fa fa-star notNull"></i></small></label> <select
								class="form-control select" name="universityVo.type" id="type"
								style="width: 100%;">
								<option value=""></option>
							</select>
						</div>
				...
				<div class="row">
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							<label for="quality"><s:text name="university.quality" /><small><i
									class="fa fa-star notNull"></i></small></label> <select
								class="form-control select" name="universityVo.quality"
								id="quality" style="width: 100%;">
								<option value=""></option>
							</select>
						</div>
					</div>
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							...
							<input type="text" 
								name="universityVo.country" id="country"
								value="${universityVo.country }" class="form-control"
								placeholder="NULL">
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							<label for="province"><s:text name="university.province" /><small><i
					...
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							<label for="city"><s:text name="university.city" /><small><i
									class="fa fa-star notNull"></i></small></label>
									<select class="form-control select"
								name="universityVo.city" id="city" style="width: 100%;">
								<option value=""></option>
							</select>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							<label for="detail_addr"><s:text name="university.detail_addr" /><small><i
									class="fa fa-star notNull"></i></small></label>
							<div class="input-group">
								<span class="input-group-addon"><li class="fa fa-file-text"></li></span> 
								<input type="text"
									name="universityVo.detail_addr" id="detail_addr"
									value="${universityVo.detail_addr }" class="form-control"
									placeholder="NULL">
							</div>
						</div>
					</div>
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon"><li class="fa fa-file-text"></li></span> 
									<input type="text"
									name="universityVo.website" id="website"
									value="${universityVo.website }" class="form-control"
									placeholder="NULL">
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							<label for="description"><s:text name="university.phone" /></label>
							<div class="input-group">
								<span class="input-group-addon"><li
									class="fa fa-phone"></li></span> <input type="text"
									name="universityVo.phone" id="phone"
									value="${universityVo.phone}" class="form-control"
									placeholder="NULL">
							</div>
						</div>
					</div>
						...
						<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon"><li
									...
									name="universityVo.email" id="email"
									value="${universityVo.email }" class="form-control"
									placeholder="NULL">
							</div>
						</div>
					</div>
				...
				<div class="row">
						...
						<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon"><li
									...
									name="universityVo.create_time" id="create_time"
									value="${universityVo.create_time }" class="form-control"
									placeholder="NULL">
							</div>
						</div>
					</div>
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							<label><s:text
									name="createPerson" /></label>
							<div class="input-group">
								<span class="input-group-addon"><li
									class="fa fa-user"></li></span> <input type="text" readonly
									name="universityVo.create_user" id="create_user"
									value="${universityVo.create_user }" class="form-control"
									placeholder="NULL">
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon"><li
									class="fa fa-calendar"></li></span> <input type="text" readonly
									name="universityVo.update_time" id="update_time"
									value="${universityVo.update_time }" class="form-control"
									placeholder="NULL">
							</div>
						</div>
					</div>
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							<label><s:text
									name="updatePerson" /></label>
							<div class="input-group">
								<span class="input-group-addon"><li
									class="fa fa-user"></li></span> <input type="text" readonly
									name="universityVo.update_user" id="update_user"
									value="${universityVo.update_user }" class="form-control"
									placeholder="NULL">
							</div>
						</div>
					</div>
					...
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" readonly name="universityVo.id" id="id"

...
<!-- 页面js -->
<script
	src="${pageContext.request.contextPath}/campusRecruit/univ/coop/addCoopHis.js"></script>
<!-- js国际化 -->
<script
...
<body>
	...
	<div class="box box-primary" id="box">
		<form id="addForm">
			<input id="coopId" name='coopHisVo.coop_id' value="${coopVo.id}" style="display: none" />
			<!-- /.box-header -->
			<div class="box-body">
				<div class="row">
			    ...
			    <div class="row">
				     <div class="col-md-12 col-xs-12">
						<div class="form-group">
							<label for="coopStatus"><s:text name="coop.status"/></label>
								<select class="form-control select" class="coopStatus"
								name="coopHisVo.status" id="coopStatus"
								style="width: 100%;">
								<option value=""></option>
							</select>
						</div>
				...
				<div class="row">
					<div class="col-md-12 col-xs-12">	
						<div class="form-group">
							<label for="remark"><s:text name="coop.remark"/></label>
							<div class="input-group">
								<textarea name="coopHisVo.remark" style="font-size:14px;" 
								maxlength="100" cols="80" rows="5"   
								id="remark" class="form-control" placeholder="Remark"></textarea>
							</div>
						</div>
					</div>
				</div>

...
<!-- 页面js -->
<script src="${pageContext.request.contextPath}/campusRecruit/univ/university/branch/addUnivBranch.js"></script> 
		...
		<form id="addForm">
			...
			<div class="box-body">
				<div class="row">
							...
							<div class="input-group">
								<span class="input-group-addon"><li
									class="fa  fa-university"></li></span> <input type="text" readonly
									 value="${universityVo.name}"id="universityName" class="form-control"
									placeholder=NULL>
							</div>
						</div>
					</div>  
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							<label for="universityName"><s:text name="univBranch.name"/><small><i class="fa fa-star notNull"></i></small></label>
							<div class="input-group">
								<span class="input-group-addon"><li
									class="fa fa-university"></li></span> <input type="text"
									name="universityVo.name" id="universityName" class="form-control"
									placeholder="UnivBranch Name">
							</div>
						</div>
					</div>
				</div>
		     	...
		     	<div class="row">
					<div class="col-md-6 col-xs-6">
							<div class="type">
								<label for="parent_name"><s:text name="univBranch.type"/><small><i class="fa fa-star notNull"></i></small></label>
						...
						<div class="col-md-6 col-xs-6">
							<div class="form-group">
								<label for="quality"><s:text name="univBranch.quality"/></label><small><i class="fa fa-star notNull"></i></small></label>
									<select class="form-control select"
				...
				<div class="row">
					...
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							<label for="regionName"><s:text name="univBranch.province"/><small><i class="fa fa-star notNull"></i></small></label>
				...
				<div class="row">
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							<label for="secondregionName"><s:text name="univBranch.city"/><small><i class="fa fa-star notNull"></i></small></label>
							<select
								class="form-control select" class="secondregionName"
						...
						<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon"><li
									...
									placeholder="University Detail Address">
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							<label for="name_en_US"><s:text name="univBranch.website"/></label>
							<div class="input-group">
								<span class="input-group-addon"><li
									class="fa fa-file-text"></li></span> </label><input type="text"
					...
					<div class="col-md-6 col-xs-6">
						<div class="form-group">
							<label for="name"><s:text name="univBranch.phone"/></label>
							<div class="input-group">
								<span class="input-group-addon"><li
									class="fa fa-phone"></li></span> <input type="text"
									name="universityVo.phone" id="phone" class="form-control"
				...
				<div class="row">
				   <div class="col-md-6 col-xs-6">
						<div class="form-group">
							<label for="name_en_US"><s:text name="univBranch.email"/></label>
							<div class="input-group">
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" readonly name="universityVo.id"
									id="getid" value="${universityVo.id }"

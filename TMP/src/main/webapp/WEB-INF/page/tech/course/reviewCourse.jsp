		...
		<div class="box" id="box">
			<form id="addSkillPointForm">
				<div class="box-header">
					<s:text name="course.reviewCourseTitle">
...
$(function() {
	...
	$.ajax({
		url:"../tech/course!reviewCourse.do",
		data: {"courseVo.id": '${courseVo.id}'},
		dataType:"json",
		type:"post",
		success:function(data){
			if(data.success=='true'){
				if(data.datas.courseList=="[]"){
					$('#treeview').html("<blockquote>"+ "<p>"+noPointDataInCourse+"</p>"+// 此课程没有知识点数据 - 

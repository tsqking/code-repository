...
<!-- 页面js -->
 <script src="${pageContext.request.contextPath}/tech/plan/personalPlan/studentPlan/paperManager.js"></script> 
<!-- js国际化 -->
...
<body>
   <section class="content" id="content"
	...
	<div class="box box-primary collapsed-box" id="box">
		...
		<form id="searchForm">
			<input id="planId" name="plan_paper_id" value="${planPaperVo.plan_id}" style="display: none" />
			...
			<div class="box-body">
				...
				<div class="row">
					<div class="col-md-4 col-xs-4">	
				     ...
				     <div class="col-md-4 col-xs-4">
						<div class="form-group">
							<label><s:text name="paper.start.time"/></label> 
							<div class="input-group">
							<div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
							<input type="text"  name="start_time"  id="start_time" class="form-control" 
							style="width: 100%;" placeholder="Start time">
							</div>
						</div>
					 </div>
					<div class="col-md-4 col-xs-4">	
						<div class="form-group">
							<label><s:text name="paper.end.time"/></label> 
							<div class="input-group">
							<div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
							<input type="text"  name="end_time"  id="end_time" class="form-control" 
							style="width: 100%;" placeholder="End time">
							</div>
						</div>
					</div>
				</div>

...
<!-- 页面js -->
<script src="${pageContext.request.contextPath}/tech/plan/personalPlan/studentReviewPlan.js"></script>
<!-- 页面js国际化 -->
		...
		<div class="content-wrapper">
			<div class="container">
				<section class="content-header">
					<h1>
						<s:text name="pp.sReviewPlanTitle"/> 
						<small><s:text name="pp.sReviewPlanTitles"/></small>
					</h1>
				</section>

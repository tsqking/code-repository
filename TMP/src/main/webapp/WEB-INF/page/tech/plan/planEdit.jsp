...
<!-- 页面js -->
<script src="${pageContext.request.contextPath}/tech/plan/planEdit.js"></script>
<!-- js国际化 -->
<script
					...
					<div class="col-md-12 col-xs-12">
						<div class="col-md-2 col-xs-2 col-md-offset-6 col-xs-offset-6">
							<span data-toggle="tooltip"
									title="<s:text name="plan.resetTip"/>">
										<button type="button" id="reset"
											class="btn btn-block btn-info btn-sm">
											<!-- 重置时间 -->
											<li class="fa fa-refresh"></li>&nbsp;&nbsp;
											<!-- 重置时间 -->
											<s:property value="getText('plan.reSetTime')" />
										</button>
								</span>
						</div>
						<div class="col-md-2 col-xs-2">
							<span data-toggle="tooltip"
									title="<s:text name="plan.saveTip"/>">
										<button type="button" id="editIframe"
											class="btn btn-block btn-success btn-sm">
											<!-- 更新信息 -->
											<li class="glyphicon glyphicon-ok"></li>&nbsp;&nbsp;
											<!-- 更新信息 -->
											<s:property value="getText('plan.updateInfo')" />
										</button> <span>
						</div>
						<div class="col-md-2 col-xs-2">
							<button type="button" id="closeIframe"
										...
										<!-- 关闭详细信息窗口 -->
										<s:property value="getText('plan.closeDeatilWin')" />
									</button>
						</div>
					</div>
				</div>

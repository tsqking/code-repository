		...
		success : function(data) {
			if (data.success == 'true') {
				if (data.message == '1') {//删除失败
					...
					var info = feedback_course_id_name+":"+data.course_id_name+"&nbsp;&nbsp;&nbsp;&nbsp;"+feedback_class_id_name+":"+data.class_id_name+// I18N - feedback_course_id_name:课程名称 feedback_class_id_name:班级名称 
...
function tableInit(param){
	...
	// 初始化BootStrapTable
	btTable = BtTable('table', "../tech/teacherPlan!selectFeedBackList.do"+param, 'toolbar',  
			[ 
			//{	field : '',checkbox : true,}, 
			{

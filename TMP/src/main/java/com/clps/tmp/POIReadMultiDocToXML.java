 ...
 */
public class POIReadMultiDocToXML {
	private static Logger log = LoggerFactory.getLogger(POIReadMultiDocToXML.class);
	...
	public static void main(String[] args) {
		...
		try {
			...
			String [] filePath=GetFileName.getFileName("D:\\CLPS\\Work\\FU\\系统");//new String[]{"D:\\CLPS\\Work\\FU\\系统\\金融IT人才测评报名表-v2.docx.docx","D:\\CLPS\\Work\\FU\\系统\\david金融IT人才测评报名表-v2.docx.docx"};
			read07TableByXWPF(filePath,wordName,alignName);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public static void read07TableByXWPF(String[] filePath, String [] names, String[] aligns){
		...
		try {
				...
				is = new FileInputStream("D:\\CLPS\\Work\\FU\\系统\\"+filePath[x]);
				doc = new XWPFDocument(is);

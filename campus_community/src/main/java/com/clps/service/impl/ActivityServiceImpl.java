...
public class ActivityServiceImpl implements IActivityService {
	...
	@Override
	public boolean applyAct(List<Map<String, Object>> applylist) throws ActivityServiceException {
		if (applylist != null) {
			return dao.actApply(applylist);
		}
		return flag;
	}

	@Override
	public PageVo<Map<String, Object>> listAcApply(PageVo<Map<String, Object>> pv) throws ActivityServiceException {
		Map<String, Object> map = new HashMap<>();
		HashMap<String, String> where = pv.getWhere();
		...
		List<Map<String, Object>> aclist = dao.listAcApply(map);
		PageVo<Map<String, Object>> pageVo = new PageVo<>();
		if (aclist != null) {
			pageVo.setList(aclist);
			pageVo.setCount(Integer.toString(dao.countAcApply(map)));
			return pageVo;
		}
		return null;
	}
